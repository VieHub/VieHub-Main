...
export function useCreatePrivateContest() {
  const user = useAuth(); // Use the useAuth hook to access the current user

  return useMutation({
    mutationKey: ["createPrivateContest"],
    ...
    mutationFn: async (data: CreateContestData) => {
      ...
      return api
        .post("/api/private-contest/create", formData, {
          headers: {
...
// export function useCreatePrivateContestWithAI() {
//   const user = useAuth(); // Use the useAuth hook to access the current user

//   return useMutation({
//     mutationKey: ["createPrivateContestWithAI"],
...
//       // Make the POST request
//       return api
//         .post("/api/private-contest/preview", formData, {
//           headers: {
//             "Content-Type": "multipart/form-data",
//           },
//         })
